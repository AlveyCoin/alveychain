...
build:
	...
	go build -o alveychain -ldflags="\
    	-X 'github.com/alveycoin/alveychain/versioning.Version=$(LATEST_VERSION)' \
		-X 'github.com/alveycoin/alveychain/versioning.Commit=$(COMMIT_HASH)'\
		-X 'github.com/alveycoin/alveychain/versioning.Branch=$(BRANCH)'\
		-X 'github.com/alveycoin/alveychain/versioning.BuildTime=$(TIME)'" \
	main.go
...
test-e2e:
	...
	go build -race -o artifacts/alveychain .
	env EDGE_BINARY=${PWD}/artifacts/alveychain go test -v -timeout=30m ./e2e/...
